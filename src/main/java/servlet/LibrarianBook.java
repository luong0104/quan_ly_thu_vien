...
/**
 * Servlet implementation class LibrarianBook
 */
@WebServlet("/LibrarianBook")
public class LibrarianBook extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{		
			...
			out.print("</br></br>");
			out.print("</tr>");
			out.println("<a href='themsach.jsp'>Thêm Sách</a>");
			...
			while (rs.next()) {
				out.print("<tr><td>" + rs.getString(1)
						...
						+ "<a href='UpdateBook?id="+ rs.getString(1) +"'>Sửa  |  </a> "
						+ "<a href='DeleteBook?id="+ rs.getString(1) +"'>Xóa</a> "
						+ "</td></tr>");
			}
			out.print("</table>");
